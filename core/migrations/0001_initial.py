# Generated by Django 4.2.30 on 2026-06-10 04:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('buyer', 'Buyer'), ('vendor', 'Vendor'), ('shipper', 'Shipped ID'), ('out_for_delivery', 'Out for Delivery ID'), ('delivered', 'Delivered ID')], default='buyer', max_length=20)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='profiles/')),
                ('raw_password_view', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offer_percentage', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('confirmed', 'Order Confirmed'), ('shipped', 'Shipped'), ('out_for_delivery', 'Out for Delivery'), ('delivered', 'Delivered')], default='confirmed', max_length=30)),
                ...
                ('buyer', models.ForeignKey(limit_choices_to={'role': 'buyer'}, on_delete=django.db.models.deletion.CASCADE, related_name='buyer_orders', to=settings.AUTH_USER_MODEL)),
